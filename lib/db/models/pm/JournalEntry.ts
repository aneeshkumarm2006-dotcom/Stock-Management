...
export interface IJournalEntry {
  ...
  /** Set when generated by the recurring poster; null for manual entries. */
...
// One recurring rule → one JE per period, enforced by the database rather than
// by the poster remembering to check. Partial so only recurring-generated rows
// participate; pre-existing entries have no recurringTransactionId.
JournalEntrySchema.index(
